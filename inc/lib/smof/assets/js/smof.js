...
jQuery(document).ready(function($){
	...
	// event.preventDefault();
		...
		if ( $(this).parent().hasClass( 'customcss' ) ) {
			window.location.href = 'admin.php?page=laborator_custom_css';
			return;
		}
		
		if ( $(this).parent().hasClass( 'changelog' ) ) {
			window.open( 'http://documentation.laborator.co/kb/kalium/kalium-changelog/' );
			return;
		}
