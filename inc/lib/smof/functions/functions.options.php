...
$of_options[] = array( 	'desc' 		=> "Lightbox gallery<br><small class=\"note\">{$note_str} Each product image will contain a + icon to view all product images on lightbox.</span>",
