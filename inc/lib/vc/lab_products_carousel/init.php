...
class WPBakeryShortCode_lab_products_carousel extends  WPBakeryShortCode {
	...
	public function content( $atts, $content = null ) {
		...
		<div class="<?php echo $css_class; ?>" id="<?php echo $rand_id; ?>">
			...
			add_filter( 'kalium_woocommerce_product_grid_columns', '__return_false' );
				...
				<?php woocommerce_product_loop_start(); ?>
					...
					<?php
						if ( is_array( $woocommerce_loop ) ) {
							$woocommerce_loop['name'] = 'kalium-woocommerce-products-carousel';
						}
					?>
			...
			remove_filter( 'kalium_woocommerce_product_grid_columns', '__return_false' );
				...
				$productsCarousel.slick( {
					...
					responsive: [
						...
						},
						{
							breakpoint: 480,
							settings: {
								slidesToShow: <?php echo apply_filters( 'kalium_woocommerce_products_carousel_slides_to_show', 2, 'mobile' ); ?>
							}
						}
					]
				} );
