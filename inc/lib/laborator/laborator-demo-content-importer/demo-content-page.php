...
<div class="wrap" id="lab_demo_content_container">
			...
			<tfoot>
				<tr>
					<td colspan="4" class="small">
						To change PHP directives you need to modify <strong>php.ini</strong> file, for more information <a href="http://documentation.laborator.co/kb/general/recommended-php-configuration-limits/" target="_blank">please read this article</a> or contact your hosting provider.
	...
	foreach ( lab_1cl_demo_installer_get_packs() as $pack ) :
		...
		$popup_link = admin_url( 'admin.php?page=laborator-demo-content-installer&install-pack=' . sanitize_title( $name ) ) . '&#038;TB_iframe=true&#038;width=780&#038;height=550';
		?>
		<li>
