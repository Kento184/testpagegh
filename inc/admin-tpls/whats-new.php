...
<div class="kalium-whats-new">
	...
	<div class="whats-new-secondary feature-section three-col">
		...
		<div class="col">
			<img src="<?php echo kalium()->assetsUrl( 'images/admin/whats-new/woocommerce-32.jpg' ); ?>">
			<h3>WooCommerce compatibility</h3>
			<p>Added compatibility for latest stable WooCommerce version (3.2.x). Feel safe to update!</p>
		</div>
	</div>
