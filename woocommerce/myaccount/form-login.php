...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<h2><?php _e( 'Login', 'woocommerce' ); ?></h2><?php // Modified by Arlind Nushi ?>

			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide labeled-input-row labeled-input-row--equal-width"><?php // Modified by Arlind Nushi ?>
			...
			<div class="form-row form-row--remember-me">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline alternate-checkbox"><?php // Modified by Arlind Nushi ?>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form register">
			...
			<h2><?php _e( 'Register', 'woocommerce' ); ?></h2><?php // Modified by Arlind Nushi ?>
