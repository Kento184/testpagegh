...
<?php // end: modified by Arlind ?>
	...
	<form method="post" class="woocommerce-ResetPassword lost_reset_password login message-form">
		...
		<h2><?php echo kalium_woocmmerce_get_i18n_str( 'Reset Password' ); ?></h2>
		...
		<div class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last labeled-input-row">
